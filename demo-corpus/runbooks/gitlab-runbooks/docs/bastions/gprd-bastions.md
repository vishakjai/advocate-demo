...
`console-01-sv-gprd.c.gitlab-production.internal`, with an alias `gprd-console`. You can also
get a rails or psql console directly via `ssh YOURUSER-rails@gprd-console` or
`ssh YOURUSER-db@gprd-console`.
