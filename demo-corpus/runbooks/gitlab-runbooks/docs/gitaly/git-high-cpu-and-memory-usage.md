...
[kill_git_pack_objects_processes_for_repo_path.sh](https://gitlab.com/gitlab-com/runbooks/-/blob/master/scripts/kill_git_pack_objects_processes_for_repo_path.sh)
