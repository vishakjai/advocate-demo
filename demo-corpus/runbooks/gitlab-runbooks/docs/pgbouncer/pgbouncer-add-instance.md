...
- General purpose PgBouncers ([terraform module
  `pgbouncer`](https://ops.gitlab.net/gitlab-com/gl-infra/config-mgmt/-/blob/main/environments/database-gprd/pgbouncer.tf))
- Sidekiq-specific PgBouncers([terraform module
  `pgbouncer-sidekiq`](https://ops.gitlab.net/gitlab-com/gl-infra/config-mgmt/-/blob/main/environments/database-gprd/pgbouncer-sidekiq.tf))
