...
local defaultUpscaledBurnRates = ['6h', '3d'];
...
local definitionDefaults = {
  ...
  upscaledBurnRates: defaultUpscaledBurnRates,
...

{
  ...
  AggregationSet(definition)::
    ...
    definitionWithDefaults {
      ...
      getApdexRatioConfidenceIntervalMetricForBurnRate(burnRate, required=false)::
        getMetricNameForBurnRate(burnRate, 'apdexConfidenceRatio', required),
      ...
      upscaleBurnRate(burnRate)::
        self.upscaleLongerBurnRates && std.member(self.upscaledBurnRates, burnRate),
