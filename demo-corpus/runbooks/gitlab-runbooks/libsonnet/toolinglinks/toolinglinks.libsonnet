...

{
  ...
  clickhouse:: (import './clickhouse.libsonnet').clickhouse,
  clickhouseSavedQuery:: (import './clickhouse.libsonnet').savedQuery,
  ...
  opensearchDashboards:: (import './opensearch_dashboards.libsonnet').opensearchDashboards,
  ...
  memoryStore:: (import './memory_store.libsonnet').memoryStore,
