...

{
    ...
    local panels = layout.grid(
      [
        panel.timeSeries(
          ...
          yAxisLabel='Clients',
          query=|||
            max by (role) (stackdriver_redis_instance_redis_googleapis_com_clients_connected{%(selector)s})
          ||| % formatConfig,
          legendFormat='{{ role }}',
          intervalFactor=2,
        ),
        panel.timeSeries(
          ...
          query=|||
            max by (role) (stackdriver_redis_instance_redis_googleapis_com_clients_blocked{%(selector)s})
          ||| % formatConfig,
          legendFormat='{{ role }}',
          intervalFactor=2,
        ),
        panel.timeSeries(
          ...
          query=|||
            max by (role) (stackdriver_redis_instance_redis_googleapis_com_stats_connections_total{%(selector)s})
          ||| % formatConfig,
          legendFormat='{{ role }}',
          intervalFactor=2,
        ),
    ...
    local panels = layout.grid(
      [
        ...
        panel.saturationTimeSeries(
          ...
          query=|||
            sum by (role, space) (
              stackdriver_redis_instance_redis_googleapis_com_stats_cpu_utilization{%(selector)s, role = "replica"}
            ) / 60
          ||| % formatConfig,
          legendFormat='{{ role }} {{ space }}',
          interval='30s',
    ...
    local charts =
      [
        ...
        .addTarget(
          target.prometheus(
            |||
              max(slo:max:soft:gitlab_component_saturation:ratio{component="redis_memory"})
            ||| % formatConfig,
            interval='5m',
        ...
        .addTarget(
          target.prometheus(
            |||
              max(slo:max:hard:gitlab_component_saturation:ratio{component="redis_memory"})
            ||| % formatConfig,
            interval='5m',
        ...
        panel.timeSeries(
          ...
          query=|||
            max by (role) (
              stackdriver_redis_instance_redis_googleapis_com_stats_memory_usage{%(selector)s}
            )
          ||| % formatConfig,
          legendFormat='{{ role }}',
          intervalFactor=2,
        ...
        panel.timeSeries(
          ...
          query=|||
            max by (role) (
              stackdriver_redis_instance_redis_googleapis_com_stats_memory_system_memory_usage_ratio{%(selector)s}
            )
          ||| % formatConfig,
          legendFormat='{{ role }}',
          intervalFactor=2,
        ...
        panel.timeSeries(
          ...
          query=|||
            max by (role) (
              stackdriver_redis_instance_redis_googleapis_com_stats_expired_keys{%(selector)s}
            )
          ||| % formatConfig,
          legendFormat='{{ role }}',
          intervalFactor=2,
        ...
        panel.timeSeries(
          ...
          query=|||
            max by (role) (
              stackdriver_redis_instance_redis_googleapis_com_stats_keyspace_hits{%(selector)s}
            )
            /
            (
              max by (role) (
              ...
              +
              max by (role) (
                stackdriver_redis_instance_redis_googleapis_com_stats_keyspace_misses{%(selector)s}
              )
            )
          ||| % formatConfig,
          legendFormat='{{ role }}',
  ...
  memorystoreRedisDashboard(service)::
